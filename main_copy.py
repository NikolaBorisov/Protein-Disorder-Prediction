...
#this script will normalize the reliability scores from the MD predictor and will print them in the console; it will also compare the ncSPC tool with the 2 states (D/-) MD tool
...
# changed to apply for the two states:
    if val == 1:
        return True
    else:
        return False
...
# there is no mismatch to fix any more
